...
<section class="clearfix" id="main">
	...
	<section class="anchor full-screen" id="intro">
	...
	<section class="anchor " id="letter">
		<article>
		<h5>Message from our Board and Staff</h5>
		<h2><strong>Bike &amp; Build 2013:</strong> <em>A Thousand Communities</em></h2>

		<p class="intro">A rider from Spokane, Washington. A host in Natchitoches, Louisiana. A build partner in “The Little Apple,” Manhattan, Kansas. A grantee in “The Big Apple,” New York City. Bike &amp; Build’s reach in 2013 was vast and deep, impacting people across the country in rural and urban settings, across cultures and demographics. Our ten routes move from town to town across the United States with one purpose: engaging young adults in service for the affordable housing cause. </p>

		<p>Our trips, composed of 30 strangers, become their own communities. Through highs and lows, headwinds and rain, the bonds that develop are powerful and awakening and create an additional level of meaning for our young adults. But beyond that internal microcosm, each team interacts with communities and their members on a level that creates an awareness and appreciation - on both sides of that interaction - of a community different from your own. A Thousand Communities mutually reached, impacted, and empowered.</p>

		<p>Over 250 riders, ages 18-25 and teeming with idealism and energy, met on the East Coast for Bike &amp; Build’s 2013 routes. Pedaling thousands of miles, these young adults touched almost 500 churches, community centers, and schools who graciously hosted our teams. Their generosity not only sustained us calorically and socially, but allowed us to financially support affordable housing organizations in roughly 250 cities and towns through our grant program. A Thousand Communities, connected and supporting each other.</p>

		<p>Collecting and redirecting donations to our affordable housing partners is an incredibly important, measurable, and cogent part of our program, but our reach extends into tangible and intangible realms that go beyond standard metrics. In this report, we feature 2013 riders who will be service advocates far longer than their B&amp;B summer; alumni who continue to make a difference; grant partners who are making the most of the funds they receive from Bike &amp; Build; community hosts who make our rides possible; and the sponsors that support our programs. </p>

		<p>We are grateful to each and every community that supports Bike &amp; Build and are proud of the impact that we had in 2013. We invite you learn more about how to Bike &amp; Build and how your town can be a part of Bike &amp; Build’s Thousand Communities.</p> 

		<ul class="signatures clearfix">
			<li> <img src="img/content/02letter/sig-st.gif"> <span> Steve  </span> </li>
			<li> <img src="img/content/02letter/sig-jv.gif"> <span> Justin </span> </li>
			<li> <img src="img/content/02letter/sig-ns.gif"> <span> Natalie</span> </li> 
			<li> <img src="img/content/02letter/sig-bn.gif"> <span> Brendan </span> </li>
		</ul>
	...
	<section class="anchor full-screen" id="housing">
	...
	<section class="anchor " id="about">
		...
		<hr>
			...
			<ul class="routelist clearfix">
				<li> <span class="label" id="CUS"> Central US </span> Virginia Beach, VA &rarr; Cannon Beach, OR </li>
				<li> <span class="label" id="ME2SB"> ME2SB </span> Portland, ME &rarr; Santa Barbara, CA           </li>
				<li> <span class="label" id="NC2SD"> NC2SD </span> Nags Head, NC &rarr; San Diego, CA              </li>
				<li> <span class="label" id="NUS"> Northern US </span> Portsmouth, NH &rarr; Vancouver, BC      </li>
				<li> <span class="label" id="P2C"> P2C </span> Providence, RI &rarr; Half Moon Bay, CA           </li>
				<li> <span class="label" id="P2S"> P2S </span> Providence, RI &rarr; Seattle, WA                 </li>
				<li> <span class="label" id="SC2SC"> SC2SC </span> Charleston, SC &rarr; Santa Cruz, CA            </li>
				<li> <span class="label" id="SUS"> Southern US </span> Jacksonville, FL &rarr; Monterey, CA     </li>
			</ul>
			
			<h3>Regional Rides</h3>
			<ul class="routelist clearfix">
			<li> <span class="label regional"> Coastal Drift </span> Bar Harbor, ME &rarr; New York City (new for 2014)  </li>
			<li> <span class="label regional"> Chris Webber Memorial Ride </span> Orlando, FL &rarr; Fort Lauderdale, FL </li>
			<ul>
		
	</section>

	<section class="anchor " id="accomplishments">
		...
		<div class="col2 clearfix">
			...
			<p class="intro">The Bike &amp; Build Alumni Council engages riders in our cause long after they complete a trip. In 2013, the Council took on numerous projects to extend Bike &amp; Build's community impact, read more <a href="#alumni">on page 10.</a></p>
			</div>
			<div>
		...
		<div class="col1 clearfix">
			...
			<ul class="fundraisers clearfix">
				<li>
					...
					<strong> Anna Whitney, </strong> P2C</br> $11,745     
				</li>
				<li>	                            
					<img src="img/content/05accomplishments/fundraisers/JD.jpg" alt="JD">
					<strong> JD Scott, </strong> SC2SC</br> $9,025        
				</li>
				<li>	                            
					<img src="img/content/05accomplishments/fundraisers/Sam.jpg" alt="Sam">
					<strong> Samantha Peltz, </strong> CUS</br> $8,000    
				</li>
				<li>	                            
					<img src="img/content/05accomplishments/fundraisers/Rocky.jpg" alt="Rocky">
					<strong> Rocky Rockwell, </strong> NUS</br> $7,040.50 
				</li>
				<li>	                            
					<img src="img/content/05accomplishments/fundraisers/Danielle.jpg" alt="Danielle">
					<strong> Danielle Raynal, </strong> P2S</br> $6,478.63
				</li>
			</ul>
		</div>
	...
	<section class="anchor " id="scholarship">
		<header>
		...
		<p>This summer, scholarship recipients will participate in <a href="http://coastaldrift.org"target=_blank>Coastal Drift,</a> Bike &amp; Build’s inaugural ride from Bar Harbor, ME to New York City. Coastal Drift offers the Bike &amp; Build experience condensed into a three week period. Daniel, now a freshman at the University of Delaware, spoke of the value of the experience. “You aren’t just sitting back and talking about helping others. You are actually doing it.” Learn more at <a href="http://coastaldrift.org"target=_blank>coastaldrift.org.</a></p> 
			...
			<aside>
				...
				<small>
					Questions? Contact Justin Villere at <a href="mailto:justin@bikeandbuild.org"target=_blank>justin@bikeandbuild.org</a>.
				</small>
			</aside>
		<article>
	</section>

	<section class="anchor " id="grantees">
		<article>
		...
		<article>
			...
			<ul class="nav-tabs clearfix" id="grantee-tabs">
			  <li class="active"><a href="#grantee-1" data-toggle="tab"><span class="abbr">	Palmdale	</span><span class="full-name">Antelope Valley YouthBuild	</span> </a></li>
			  <li><a href="#grantee-2" data-toggle="tab">				<span class="abbr">	Portland	</span><span class="full-name">H4H Portland/Metro East	</span> </a></li>
			  <li><a href="#grantee-3" data-toggle="tab">				<span class="abbr">	Nola	</span><span class="full-name">Youth Rebuilding NOLA		</span> </a></li>
			  <li><a href="#grantee-4" data-toggle="tab">				<span class="abbr">	Pikes Peak	</span><span class="full-name">H4H Pikes Peak				</span> </a></li>
			</ul>

			<div class="tab-content" id="grantee-tab-content">
	...
	<section class="anchor " id="riders">
		<article>
			...
			<ul class="nav-tabs clearfix" id="rider-tabs">
			  <li class="active"><a href="#rider-1" data-toggle="tab">Kristin Anderson &amp; Melissa Panter</a></li>
			  <li><a href="#rider-2" data-toggle="tab">Zoe Nemerever</a></li>
			</ul>
			...
			<div class="tab-content">
			  ...
			  <div class="tab-pane" id="rider-2">
				  <article>				  
					<div class="bg-wrap">
					<header>
					<h3>Zoe Nemerever <span class="routename">Central US ’13</span></h3>
	...
	<section class="anchor " id="alumni">
		<article>
			...
			<h4>In 2013, The Alumni Council accomplished the following:</h4>
			<ul> 
				...
				<li>	Carrying out numerous recruitment activities to spread the word about Bike &amp; Build to future riders.</li>
			</ul>
			...
			<ul class="nav-tabs clearfix" id="alumni-tabs">
			...
			<div class="tab-content">
			  ...
			  <div class="tab-pane" id="alumni-2">
				...
				<p>I work as a physical therapist at an out-patient clinic. We work with people dealing with a variety of medical issues, including joint, back, and knee pain. We also work with those suffering from more serious ailments, like burn victims and traumatic injuries. It’d be great to get into teaching on the university level someday too. Ultimately, I want to be able to help people stay active and do what they love to do.</p>
	...
	<section class="anchor " id="financials">
		...
		<h4>
		<a href="http://www.bikeandbuild.org/cms/content/view/9184/368/"> Click Here </a> to view our Audited Financials and IRS Form 990s from 2011-2013.”
		</h4>
	...
	<section class="anchor " id="support">
		...
		<article>
				...
				<ul class="col6 clearfix" id="partner-logos">
					<li> <img src="img/content/12support/logo_01_bokoo.gif" alt="Bokoo Bikes Corporate logo" /> </li>
					<li> <img src="img/content/12support/logo_02_earthbalance.gif" alt="Earth Balance logo" /> </li>
					<li> <img src="img/content/12support/logo_03_fhlb.gif" alt="FHLB Boston logo" /> </li>
					<li> <img src="img/content/12support/logo_04_eastriver.gif" alt="East River Bank logo" /> </li>
					<li> <img src="img/content/12support/logo_05_hincapie.gif" alt="Hincapie logo" /> </li>
					<li> <img src="img/content/12support/logo_06_giant.gif" alt="Giant Bicycles logo" /> </li>
					<li> <img src="img/content/12support/logo_07_ccg.gif" alt="Christina Clark Genco Foundation logo" /> </li>
					<li> <img src="img/content/12support/logo_08_univest.gif" alt="Univest Capital logo" /> </li>
					<li> <img src="img/content/12support/logo_09_brinker.gif" alt="Brinker Capital logo" /> </li>
					<li> <img src="img/content/12support/logo_10_smith.gif" alt="Smith Optics logo" /> </li>
					<li> <img src="img/content/12support/logo_11_nuun.gif" alt="Nuun logo" /> </li>
				</ul>
	...
	<section class="anchor " id="contact">		
			...
			<ul class="board clearfix">
				<li> 
					<!-- <img src="img/content/14contact/StevenTruong.jpg" alt="Steven Truong"> -->
				...
				<li> 
					<!-- <img src="img/content/14contact/GeorgeJones.jpg" alt="George Jones"> -->
				...
				<li> 
					<!-- <img src="img/content/14contact/JeanineLee.jpg" alt="Jeanine Lee"> -->
				...
				<li> 
					<!-- <img src="img/content/14contact/CharlieHenderson.jpg" alt="Charlie Henderson"> -->
				...
				<li> 
					<!-- <img src="img/content/14contact/JohnLeonti.jpg" alt="John Leonti"> -->
				...
				<li>  
					<!-- <img src="img/content/prototype/person-image.jpg"  alt="Person Image"> -->
				...
				<li> 
					<!-- <img src="img/content/14contact/EdHarris.jpg"  alt="Ed Harris"> -->
 			   	...
 			   	<li> 
					<!-- <img src="img/content/14contact/DavidMichaluk.jpg"  alt="David Michaluk"> -->
					<strong>David Michaluk</strong> </br>
					<em>Member At-Large , Partnership Marketing Specialist</em></br>
					Oaklyn, NJ
				</li>
				<li> 
					<!-- <img src="img/content/14contact/KristianSekse.jpg" alt="Kristian Sekse"> -->
				...
				<li> 
					<!-- <img src="img/content/14contact/BillWest.jpg" alt="Bill West"> -->
				...
				<li> 
					<!-- <img src="img/content/14contact/KyleMagida.jpg" alt="Kyle Magida"> -->
					<strong> Kyle Magida </strong> </br> 
					<em> Alumni Council Co-Chair </em> </br>
					Madison, WI
				</li>
				<li> 
					<!-- <img src="img/content/14contact/DavidNierenburg.jpg"  alt="David Nierenburg"> -->
			...
			<ul class="staff clearfix">
				<li> 
					<!-- <img src="img/content/14contact/JustinVillere.jpg" alt="JustinVillere"> -->
				<strong> Justin Villere</strong> </br>
				Director of Operations and Outreach</br>
				<a href="mailto:justin@bikeandbuild.org" target=_blank> justin@bikeandbuild.org				</a>
				</li>
				<li> 
					<!-- <img src="img/content/14contact/BrendanNewman.jpg" alt="BrendanNewman"> -->
				<strong> Brendan Newman</strong> </br>
				Program Director</br>
				<a href="mailto:brendan@bikeandbuild.org" target=_blank>	brendan@bikeandbuild.org		</a>
				</li>
				<li> 
					<!-- <img src="img/content/14contact/NatalieSerle.jpg" alt="NatalieSerle"> -->
				<strong> Natalie Serle’</strong> </br>
				Program Director</br>
				<a href="mailto:natalie@bikeandbuild.org" target=_blank>	natalie@bikeandbuild.org		</a>
				</li>
				<li> 
					<!-- <img src="img/content/14contact/MattHartman.jpg" alt="MattHartman"> -->
				<strong> Matt Hartman</strong> </br>
				Office Coordinator</br>
				<a href="mailto:matt@bikeandbuild.org" target=_blank>	matt@bikeandbuild.org				</a>
				</li>
			</ul>

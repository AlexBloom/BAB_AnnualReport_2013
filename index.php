...
<section class="full-screen" id="intro">
	<div class="overlay-wrap">
		...
		<a class="next-section" id="" href="#letter"> Scroll To Begin <br> &darr; </a>
	</div>
</section>

<section class="" id="letter">
	<article>
	<h2>Message from our Board and Staff</h2>
	<h3><strong>Bike &amp; Build 2013:</strong> A Thousand Communities</h3>
...
<section class="" id="accomplishments">
	...
	<ul class="figures clearfix">
		...
		<li>	Sussex County Habitat for Humanity – Georgetown, DE          </li>
		<li>	Flatirons Habitat for Humanity – Lafayette, CO               </li>
		<li>	Habitat for Humanity of the Chesapeake – Baltimore, MD       </li>
		<li>	Habitat for Humanity of Kent County – Grand Rapids, MI       </li>
		<li>	Crispus Attucks Association – York, PA                       </li>
		<li>	Habitat for Humanity of the Greater Teton Area – Jackson, WY </li>
		<li>	Rebuilding Together Springfield – Springfield, MA </li>
	</ul>
	
	<h3> Bike &amp; Build Scholarship </h3>
	Bike &amp; Build offered its first every scholarship for riders from underprivileged backgrounds to participate. Actually, we awarded two! Check out those stories on page ---- (link to that page later in the report).

	<h3> Alumni Council activities </h3>
	The Bike &amp; Build Alumni Council engages riders in our cause long after they complete a trip. In 2013, the Council took on numerous projects, including:
	<ul> 
	...
	<ul>
		<li>	Anna Whitney, P2C - $11,745     </li>
		<li>	JD Scott, SC2SC - $9,025        </li>
		<li>	Samantha Peltz, CUS - $8,000    </li>
...
<section class="full-screen" id="hosts">
	<article>
	...
	<article>
		...
		<ul class="team-leaders clearfix">
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				Steve Truong </strong> </br> - Chairman of the Board</br>
				Albridge Analytics, Director, Sales and Relationship Manager</br>
				Wayne, PA 
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				Jeanine Lee </strong> </br> - Treasurer</br>
				Propeller Industries, Accounting Manager</br>
				Brooklyn, NY
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				Charlie Henderson </strong> </br> - Member At-Large</br>
				Henderson Consulting &amp; Risk Management, Owner</br>
				Newtown Square, PA 
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				John Leonti </strong> </br> - Member At-Large</br>
				Troutman Sanders LLP, Attorney</br>
				New York, NY 
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				Bill Meiklejohn </strong> </br> - Member At-Large</br> 
				President, Lancer Systems</br>
				Collegeville, PA  
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				Kristian Sekse </strong> </br> - Member At-Large</br> 
				Board of Child Care, Director of Development</br>
				Baltimore, MD  
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				Bill West </strong> </br> - Member At-Large</br>
				The Atlantic Partners, Managing Partner</br>
				Greenville, SC  
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				Kyle Magida </strong> </br> - Alumni Council Co-Chair</br>
				Madison, WI
			</li>
			<li> <img src="img/content/prototype/person-image.jpg"  alt="Person Image">
				<strong>
				David Nierenburg </strong> </br> - Alumni Council Co-Chair</br>
				Atlanta, GA
			</li>
		</ul>
